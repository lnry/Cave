...
class ModelNet40Cls(data.Dataset):
    ...
    def __init__(self, root, num_points, uniform=False, train=True, transforms=None):
        self.data_dir = os.path.join(os.path.abspath(root), "modelnet40_ply_hdf5_2048")
        self.num_points, self.train, self.uniform = num_points, train, uniform
        if self.train:
